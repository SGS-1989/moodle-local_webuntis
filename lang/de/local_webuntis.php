...
$string['admin:landingexternal'] = 'Erster Login in neuem Browser-Tab';
$string['admin:landingexternal:description'] = 'Ersten Login in einem separaten Browser-Tab durchführen.';
